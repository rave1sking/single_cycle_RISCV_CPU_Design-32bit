...
proc create_root_design { parentCell } {
  ...
  # Create instance: CPUCCtop_0, and set properties
  set CPUCCtop_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:CPUCCtop:1.0 CPUCCtop_0 ]
  ...
  connect_bd_net -net CPUCCtop_0_result [get_bd_pins CPUCCtop_0/result] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_pins CPUCCtop_0/rstn] [get_bd_pins axi_gpio_1/gpio2_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins CPUCCtop_0/clk] [get_bd_pins axi_gpio_1/gpio_io_o]
